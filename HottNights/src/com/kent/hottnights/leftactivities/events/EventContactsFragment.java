...
public class EventContactsFragment extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		for (int e = 0; e < ecFrmDb.size(); e++) {
			...
			EventContact orange = new EventContact(ecFrmDb.get(e).getEcPic(), ecFrmDb.get(e).getEcName(), ecFrmDb.get(e).getEcNumber(), ecFrmDb.get(e).getEcEmail(), ecFrmDb.get(e).getEcFbk(), ecFrmDb.get(e).getEcTwitter());
		...
		EventContactAdapter adapter = new EventContactAdapter(getActivity().getBaseContext(), evCon);
